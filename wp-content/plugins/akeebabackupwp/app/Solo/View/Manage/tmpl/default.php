		...
		<?php if (!empty($this->list)): ?>
			...
			foreach ($this->list as $record):?>
                ...
                <tr>
                    ...
                    <td>
				<span class="akeeba-icon <?php echo $originIcon ?> akeebaCommentPopover"
                      data-content-title="<?php echo Text::_('COM_AKEEBA_BUADMIN_LABEL_ORIGIN'); ?>"
                      data-content="<?php echo htmlentities($originDescription) ?>"
                ></span>

						<?php if (!empty($record['comment'])): ?>
                            <span class="glyphicon glyphicon-info-sign akeebaCommentPopover"
