...
Solo.Configuration.onBrowser=function(a,b){Solo.Configuration.onBrowserCallback=function(a){b.value=a;"object"==typeof Solo.Configuration.fsBrowser.modalObject&&Solo.Configuration.fsBrowser.modalObject.close&&Solo.Configuration.fsBrowser.modalObject.close()};var d=Solo.Configuration.URLs.browser+encodeURIComponent(a),e=document.getElementById(Solo.Configuration.fsBrowser.params.dialogBodyId);e.innerHTML="";var c=document.createElement("iframe");c.setAttribute("src",d);c.setAttribute("width","100%");
c.setAttribute("height",400);c.setAttribute("frameborder",0);c.setAttribute("allowtransparency","true");e.appendChild(c);Solo.Configuration.fsBrowser.modalObject=Solo.Modal.open({inherit:"#"+Solo.Configuration.fsBrowser.params.dialogId,width:"80%"})};Solo.Configuration.FtpBrowser.callback=function(a){var b="/".replace(/([\[\]\(\)\.\?\/\*\{\}\+\$\^\:])/g,"$1");a="/"+(a+"").replace(new RegExp("^["+b+"]+","g"),"");document.getElementById("var["+Solo.Configuration.FtpBrowser.params.key+"]").value=a};
...
"");Solo.System.doAjax({host:Solo.Configuration.FtpBrowser.params.host,username:Solo.Configuration.FtpBrowser.params.username,password:Solo.Configuration.FtpBrowser.params.password,passive:Solo.Configuration.FtpBrowser.params.passive?1:0,ssl:Solo.Configuration.FtpBrowser.params.ssl?1:0,directory:Solo.Configuration.FtpBrowser.params.directory},function(a){var b=document.getElementById("ak_crumbs2"),e=document.getElementById("ftpBrowserFolderList");e.style.display="none";b.style.display="none";if(0!=
a.error)document.getElementById("ftpBrowserError").innerHTML=a.error,document.getElementById("ftpBrowserErrorContainer").style.display="block";else{document.getElementById("ftpBrowserErrorContainer").style.display="none";if(!empty(a.breadcrumbs)){b.style.display="block";b.innerHTML="";var c="/";Solo.Configuration.FtpBrowser.addCrumb(Solo.Configuration.translations.COM_AKEEBA_FILEFILTERS_LABEL_UIROOT,"/",b);for(i=0;i<a.breadcrumbs.length;i++){var f=a.breadcrumbs[i],c=c+("/"+f);Solo.Configuration.FtpBrowser.addCrumb(f,
c,b)}}if(!empty(a.list))for(e.style.display="block",Solo.Configuration.FtpBrowser.params.directory||(Solo.Configuration.FtpBrowser.params.directory=a.directory),i=0;i<a.list.length;i++)b=a.list[i],Solo.Configuration.FtpBrowser.createLink(a.directory+"/"+b,b,e)}},function(a){document.getElementById("ftpBrowserError").innerHTML=a;document.getElementById("ftpBrowserErrorContainer").style.display="block";document.getElementById("ftpBrowserFolderList").style.display="none";document.getElementById("ftpBrowserCrumbs").style.display=
"none"},!1)};Solo.Configuration.FtpBrowser.createLink=function(a,b,d,e){"undefined"==typeof e&&(e=Solo.Configuration.FtpBrowser);var c=document.createElement("tr"),f=document.createElement("td");c.appendChild(f);var g=document.createElement("a");g.textContent=b;Solo.System.addEventListener(g,"click",function(){e.params.directory=a;e.open()});f.appendChild(g);d.appendChild(c)};
Solo.Configuration.FtpBrowser.addCrumb=function(a,b,d,e){"undefined"==typeof e&&(e=Solo.Configuration.FtpBrowser);var c=document.createElement("li"),f=document.createElement("a");f.textContent=a;Solo.System.addEventListener(f,"click",function(a){e.params.directory=b;e.open();a.preventDefault?a.preventDefault():a.returnValue=!1});c.appendChild(f);d.appendChild(c)};
...
e=document.getElementById("ak_scrumbs");b.style.display="none";e.style.display="none";if(0!=a.error)document.getElementById("sftpBrowserError").innerHTML=a.error,document.getElementById("sftpBrowserErrorContainer").style.display="block";else{document.getElementById("ftpBrowserErrorContainer").style.display="none";if(!empty(a.breadcrumbs)){e.style.display="block";e.innerHTML="";var c="/";Solo.Configuration.FtpBrowser.addCrumb(Solo.Configuration.translations.COM_AKEEBA_FILEFILTERS_LABEL_UIROOT,"/",
e,Solo.Configuration.SftpBrowser);for(i=0;i<a.breadcrumbs.length;i++){var f=a.breadcrumbs[i],c=c+("/"+f);Solo.Configuration.FtpBrowser.addCrumb(f,c,e,Solo.Configuration.SftpBrowser)}}if(!empty(a.list))for(b.style.display="block",Solo.Configuration.SftpBrowser.params.directory||(Solo.Configuration.SftpBrowser.params.directory=a.directory),i=0;i<a.list.length;i++)e=a.list[i],Solo.Configuration.FtpBrowser.createLink(a.directory+"/"+e,e,b,Solo.Configuration.SftpBrowser)}},function(a){document.getElementById("sftpBrowserError").innerHTML=
...
Solo.Configuration.parseGuiData=function(a,b){null==b&&(b=document.getElementById("akeebagui"));b.innerHTML="";var d=0,e;for(e in a)if(a.hasOwnProperty(e)){var c=a[e];d++;if(!empty(c)){var f=document.createElement("div");f.className="well";b.appendChild(f);var g=document.createElement("h4");g.id="auigrp_"+b.id+"_"+d;g.innerHTML=e;f.appendChild(g);for(var h in c)if(c.hasOwnProperty(h)){var g=c[h],k="var["+h+"]",l=document.createElement("div");l.className="akeeba-ui-optionrow form-group";l.id="akconfigrow."+
h;"hidden"!=g.type&&"none"!=g.type&&f.appendChild(l);Solo.Configuration.GUI.renderOptionLabel(k,g,l);var m=document.createElement("div");m.className="col-sm-9";var n="renderOptionType"+(g.type[0].toUpperCase()+g.type.slice(1));if("function"===typeof Solo.Configuration.GUI[n])Solo.Configuration.GUI[n](k,g,m,l,f);else Solo.Configuration.GUI.renderOptionTypeUnknown(k,g,m,l,f)}}}};
Solo.Configuration.GUI.renderOptionLabel=function(a,b,d){if("hidden"!=b.type&&"none"!=b.type){var e=document.createElement("label");e.className="control-label col-sm-3";e.setAttribute("for",a);e.innerHTML=b.title;b.description&&(e.setAttribute("rel","popover"),e.setAttribute("data-original-title",b.title),e.setAttribute("data-content",b.description));b.bold&&(e.style.fontWeight="bold");d.appendChild(e)}};Solo.Configuration.GUI.renderOptionTypeNone=function(a,b,d,e,c){};
Solo.Configuration.GUI.renderOptionTypeHidden=function(a,b,d,e,c){d=document.createElement("input");d.id=a;d.setAttribute("type","hidden");d.setAttribute("name",a);d.setAttribute("size","40");d.value=b["default"];c.appendChild(d)};Solo.Configuration.GUI.renderOptionTypeSeparator=function(a,b,d,e,c){a=document.createElement("div");a.className="akeeba_ui_separator";c.appendChild(a)};
Solo.Configuration.GUI.renderOptionTypeCheckandhide=function(a,b,d,e,c){c=document.createElement("span");d.appendChild(c);e.appendChild(d);d=document.createElement("input");d.setAttribute("type","hidden");d.id=a;d.setAttribute("name",a);d.setAttribute("size","40");d.value=b["default"];c.appendChild(d);a=b.labelempty;""!=b["default"]&&(a=b.labelnotempty);d=document.createElement("span");d.textContent=a;c.appendChild(d);Solo.System.data.set(d,"labelempty",b.labelempty);Solo.System.data.set(d,"labelnotempty",
b.labelnotempty)};Solo.Configuration.GUI.renderOptionTypeInstaller=function(a,b,d,e,c){c=document.createElement("select");c.className="form-control";c.id=a;c.setAttribute("name",a);for(key in Solo.Configuration.installers)if(Solo.Configuration.installers.hasOwnProperty(key)){a=Solo.Configuration.installers[key];var f=document.createElement("option");f.value=key;f.innerHTML=a.name;b["default"]==key&&f.setAttribute("selected",1);c.appendChild(f)}d.appendChild(c);e.appendChild(d)};
Solo.Configuration.GUI.renderOptionTypeEngine=function(a,b,d,e,c){var f=b.subtype;if(null!=Solo.Configuration.engines[f]){var g=a.substr(4,a.length-5),h=document.createElement("div");h.id=g+"_config";h.className="hidden";var k=document.createElement("select");k.id=a;k.className="form-control";k.setAttribute("name",a);a=Solo.Configuration.engines[f];for(var l in a)if(a.hasOwnProperty(l)){c=a[l];var m=document.createElement("option");m.value=l;m.innerHTML=c.information.title;b["default"]==l&&m.setAttribute("selected",
"selected");k.appendChild(m)}Solo.System.addEventListener(k,"change",function(a){a={};var b=[document.getElementById(g+"_config").querySelectorAll("input"),document.getElementById(g+"_config").querySelectorAll("select")],c,d,e;for(i=0;i<b.length;i++)if(c=b[i],c.length)for(j=0;j<c.length;j++)d=c[j],e=d.id,a[e]=d.value,"checkbox"==d.getAttribute("type")?a[e]=d.checked:"select"==d.getAttribute("type")&&(a[e]=d.options[d.selectedIndex].value);b=Solo.Configuration.engines[f][k.value];c={};c[b.information.title]=
b.parameters;Solo.Configuration.parseGuiData(c,h);c=h.querySelector("h4");null!=c&&c.insertAdjacentHTML("afterend",'<p class="alert alert-info">'+b.information.description+"</p>");b=[document.getElementById(g+"_config").querySelectorAll("input"),document.getElementById(g+"_config").querySelectorAll("select")];for(i=0;i<b.length;i++)if(c=b[i],c.length)for(j=0;j<c.length;j++)d=c[j],e=d.id,e=a[e],null!=e&&void 0!=e&&("checkbox"==d.getAttribute("type")?e?d.setAttribute("checked","checked"):d.removeAttribute("checked"):
d.value=e,1==i&&Solo.System.triggerEvent(d,"change"));Solo.Configuration.enablePopoverFor(h.querySelectorAll('[rel="popover"]'))});l=document.createElement("button");l.innerHTML=Solo.Configuration.translations.COM_AKEEBA_CONFIG_UI_CONFIG;l.className="btn btn-sm btn-default";a=document.createElement("span");a.className="glyphicon glyphicon-cog";l.appendChild(a);Solo.System.addEventListener(l,"click",function(a){Solo.System.toggleClass(h,"hidden");a.preventDefault?a.preventDefault():a.returnValue=!1});
a=document.createElement("div");a.className="input-group";c=document.createElement("span");c.className="input-group-btn";c.appendChild(l);a.appendChild(k);a.appendChild(c);d.appendChild(a);d.appendChild(h);e.appendChild(d);null!=Solo.Configuration.engines[f][b["default"]]&&(d=Solo.Configuration.engines[f][b["default"]],e=d.information.title,l={},l[e]=d.parameters,0!=b["protected"]&&(document.createElement("span").textContent=e,k.style.display="none"),Solo.Configuration.parseGuiData(l,h),b=h.querySelector("h4"),
null!=b&&b.insertAdjacentHTML("afterend",'<p class="alert alert-info">'+d.information.description+"</p>"))}};
Solo.Configuration.GUI.renderOptionTypeBrowsedir=function(a,b,d,e,c){var f=document.createElement("input");f.setAttribute("type","text");f.setAttribute("name",a);f.setAttribute("size","30");f.className="form-control";f.id=a;f.value=b["default"];a=document.createElement("button");a.className="btn btn-default";a.innerHTML="&nbsp;";a.setAttribute("title",Solo.Configuration.translations.COM_AKEEBA_CONFIG_UI_BROWSE);b=document.createElement("span");b.className="input-group-btn";c=document.createElement("span");
c.className="glyphicon glyphicon-folder-open";a.appendChild(c);Solo.System.addEventListener(a,"click",function(a){a.preventDefault?a.preventDefault():a.returnValue=!1;if(null!=Solo.Configuration.onBrowser)Solo.Configuration.onBrowser(f.value,f);return!1});c=document.createElement("span");c.className="input-group";b.appendChild(a);c.appendChild(f);c.appendChild(b);d.appendChild(c);e.appendChild(d)};
Solo.Configuration.GUI.renderOptionTypeButtonedit=function(a,b,d,e,c){var f="hidden"==b.editortype?"hidden":"text";c=document.createElement("input");c.className="form-control";c.setAttribute("type",f);c.setAttribute("name",a);c.setAttribute("size",30);c.value=b["default"];"1"==b.editordisabled&&c.setAttribute("disabled","disabled");a=document.createElement("span");a.className="input-group-btn";f=document.createElement("button");f.innerHTML=Solo.Configuration.translations[b.buttontitle];f.className=
"btn btn-default";a.appendChild(f);Solo.System.addEventListener(f,"click",function(a){a.preventDefault?a.preventDefault():a.returnValue=!1;a=b.hook;try{eval(a+"()")}catch(h){}});f=document.createElement("span");f.className="input-group";f.appendChild(c);f.appendChild(a);d.appendChild(f);e.appendChild(d)};
Solo.Configuration.GUI.renderOptionTypeEnum=function(a,b,d,e,c){c=document.createElement("select");c.className="form-control";c.id=a;c.setAttribute("name",a);a=b.enumvalues.split("|");var f=b.enumkeys.split("|");for(counter=0;counter<a.length;counter++){var g=a[counter],h=f[counter],k=document.createElement("option");k.value=g;k.innerHTML=h;g==b["default"]&&k.setAttribute("selected","selected");c.appendChild(k)}d.appendChild(c);e.appendChild(d)};
Solo.Configuration.GUI.renderOptionTypeString=function(a,b,d,e,c){c=document.createElement("input");c.className="form-control";c.setAttribute("type","text");c.id=a;c.setAttribute("name",a);c.setAttribute("size",40);c.value=b["default"];d.appendChild(c);e.appendChild(d)};
Solo.Configuration.GUI.renderOptionTypePassword=function(a,b,d,e,c){Solo.Configuration.passwordFields[a]=b["default"];c=document.createElement("input");c.className="form-control";c.setAttribute("type","password");c.id=a;c.setAttribute("name",a);c.setAttribute("size",40);c.value=b["default"];c.setAttribute("autocomplete","off");d.appendChild(c);e.appendChild(d)};
...
a=a*b.scale;a<b.min?a=b.min:a>b.max&&(a=b.max);f.value=a;g.value=(a/b.scale).toFixed(2)});var h=document.createElement("select");h.id=c+"_dropdown";h.setAttribute("name",c+"_dropdown");h.className="form-control akeeba-form-control-mini";c=b.shortcuts.split("|");var k=b.scale;a=!1;for(counter=0;counter<c.length;counter++){var l=c[counter],m=l/k,n=document.createElement("option");n.value=l;n.innerHTML=m.toFixed(2);l==b["default"]&&(n.setAttribute("selected","selected"),a=!0);h.appendChild(n)}c=document.createElement("option");
c.value=-1;c.innerHTML="Custom...";a||(c.setAttribute("selected","selected"),g.value=(b["default"]/b.scale).toFixed(2),g.style.display="inline-block");h.appendChild(c);Solo.System.addEventListener(h,"change",function(){var a=h.value;-1==a?(g.value=(b["default"]/b.scale).toFixed(2),g.style.display="inline-block",Solo.System.triggerEvent(g,"focus")):(f.value=a,g.style.display="none")});a=b.uom;"string"!=typeof a||empty(a)?(a="",d.appendChild(h),d.appendChild(g)):(c=document.createElement("div"),c.className=
"input-group",k=document.createElement("span"),k.className="input-group-addon",k.textContent=" "+a,c.appendChild(h),c.appendChild(g),c.appendChild(k),d.appendChild(c));d.appendChild(f);e.appendChild(d)};
Solo.Configuration.GUI.renderOptionTypeBool=function(a,b,d,e,c){c=document.createElement("div");c.className="akeeba-ui-checkbox";var f=document.createElement("input");f.setAttribute("name",a);f.setAttribute("type","hidden");f.value=0;c.appendChild(f);f=document.createElement("input");f.id=a;f.setAttribute("name",a);f.setAttribute("type","checkbox");f.setAttribute("value",1);0!=b["default"]&&f.setAttribute("checked","checked");c.appendChild(f);d.appendChild(c);e.appendChild(d)};
Solo.Configuration.GUI.renderOptionTypeButton=function(a,b,d,e,c){c=e.querySelector("label");var f=b.hook;b=c.innerHTML;var g=document.createElement("button");g.id=a;g.innerHTML=b;g.className="btn btn-default";c.innerHTML="&nbsp;";Solo.System.addEventListener(g,"click",function(a){a.preventDefault?a.preventDefault():a.returnValue=!1;try{eval(f+"()")}catch(k){}});d.appendChild(g);e.appendChild(d)};
Solo.Configuration.GUI.renderOptionTypeUnknown=function(a,b,d,e,c){a=a.substr(4,a.length-5);d="akeeba_render_"+b.type;c=window[d];if("function"==typeof c)c(a,b,label,e);else try{eval(d+"(config_key, defdata, label, row_div)")}catch(f){}};akeeba_directftp_init_browser=function(){Solo.Configuration.FtpBrowser.initialise("engine.archiver.directftp.initial_directory","engine.archiver.directftp")};
akeeba_postprocftp_init_browser=function(){Solo.Configuration.FtpBrowser.initialise("engine.postproc.ftp.initial_directory","engine.postproc.ftp")};akeeba_directsftp_init_browser=function(){Solo.Configuration.SftpBrowser.initialise("engine.archiver.directsftp.initial_directory","engine.archiver.directsftp")};akeeba_postprocsftp_init_browser=function(){Solo.Configuration.FtpBrowser.initialise("engine.postproc.sftp.initial_directory","engine.postproc.sftp")};
directftp_test_connection=function(){Solo.Configuration.FtpTest.testConnection("engine.archiver.directftp.ftp_test","engine.archiver.directftp")};postprocftp_test_connection=function(){Solo.Configuration.FtpTest.testConnection("engine.postproc.ftp.ftp_test","engine.postproc.ftp")};directftpcurl_test_connection=function(){Solo.Configuration.FtpTest.testConnection("engine.archiver.directftpcurl.ftp_test","engine.archiver.directftpcurl")};
postprocftpcurl_test_connection=function(){Solo.Configuration.FtpTest.testConnection("engine.postproc.ftpcurl.ftp_test","engine.postproc.ftpcurl")};directsftp_test_connection=function(){Solo.Configuration.SftpTest.testConnection("engine.archiver.directsftp.sftp_test","engine.archiver.directsftp")};postprocsftp_test_connection=function(){Solo.Configuration.SftpTest.testConnection("engine.postproc.sftp.sftp_test","engine.postproc.sftp")};
directsftpcurl_test_connection=function(){Solo.Configuration.SftpTest.testConnection("engine.archiver.directsftpcurl.sftp_test","engine.archiver.directsftpcurl")};postprocsftpcurl_test_connection=function(){Solo.Configuration.SftpTest.testConnection("engine.postproc.sftpcurl.sftp_test","engine.postproc.sftpcurl")};akconfig_dropbox_openoauth=function(){var a=Solo.Configuration.URLs.dpeauthopen,a=-1==a.indexOf("?")?a+"?":a+"&";window.open(a+"engine=dropbox","akeeba_dropbox_window","width=1010,height=500")};
