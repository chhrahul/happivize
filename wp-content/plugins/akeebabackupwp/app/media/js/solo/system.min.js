...
Solo.System.params.errorCallback(a):c(a)}};d?Solo.Ajax.enqueue(f):Solo.Ajax.ajax(f)};Solo.System.checkAll=function(a,b){b||(b="cb");if(a.form){for(var c=0,d=0,f=a.form.elements.length;d<f;d++){var e=a.form.elements[d];e.type==a.type&&(b&&0==e.id.indexOf(b)||!b)&&(e.checked=a.checked,c+=1==e.checked?1:0)}a.form.boxchecked&&(a.form.boxchecked.value=c);return!0}return!1};Solo.System.isChecked=function(a,b){"undefined"===typeof b&&(b=document.getElementById("adminForm"));1==a?b.boxchecked.value++:b.boxchecked.value--};
Solo.System.tableOrdering=function(a,b,c,d){"undefined"===typeof d&&(d=document.getElementById("adminForm"));d.filter_order.value=a;d.filter_order_Dir.value=b;Solo.System.submitForm(d.getAttribute("id"),c)};
