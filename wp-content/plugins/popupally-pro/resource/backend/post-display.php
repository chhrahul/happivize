...
<table class="form-table" style="text-align:center;">
	<tbody>
		<tr valign="top">
			...
			<th style="font-size:12px;padding:0 5px;">Scroll triggered</th>
			<th style="font-size:12px;padding:0 5px;">Click triggered</th>
		...
		<tr valign="top">
			...
			<td>
				<?php echo in_array('scroll', $type) ? '&#x2714;' : ''; ?>
			</td>
			<td>
				<?php echo in_array('click', $type) ? '&#x2714;' : ''; ?>
			</td>
			<td>
