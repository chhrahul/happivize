<tr class="css-customization-element css-item-{{identifier}}-{{variable-name}}">
	...
	<td class="popupally-customization-table-content">
		{{start-inherit-code}}
		<input size="8" class="nqpc-picker-input-iyxm" name="{{base-setting-name}}[css][{{variable-name}}]" {{auto-adjust}} type="text" value="{{value}}" preview-update-target-css-placeholder-color="#popupally-preview-{{preview-element}}">
		{{end-inherit-code}}
	</td>
