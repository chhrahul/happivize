<tr class="css-customization-element css-item-{{identifier}}-{{variable-name}}">
	...
	<td class="popupally-customization-table-content">
		{{start-inherit-code}}
		<input size="8" name="{{base-setting-name}}[css][{{variable-name}}]" {{auto-adjust}} type="text" value="{{value}}" preview-update-target-css="#popupally-preview-{{preview-element}}" preview-update-target-css-property="{{variable-name}}">
		{{end-inherit-code}}
	</td>
