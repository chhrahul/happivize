...
<div class="popupally-sub-setting-content-container" popupally-responsive-tab-group-{{id}}-plsbvs="0">
	...
	<input style="display:none;" type="checkbox" popup-id="{{id}}" template-id="plsbvs" signup-form-hide="form" value="true"/>
	<input style="display:none;" type="checkbox" checked popup-id="{{id}}" template-id="plsbvs" signup-form-hide="lname" value="true"/>
	<input style="display:none;" type="checkbox" popup-id="{{id}}" template-id="plsbvs" signup-form-hide="email" value="true"/>
	<div class="popupally-setting-section" id="plsbvs-customization-section-{{id}}">
		...
		<div class="popupally-configure-element">
				...
				<div>
					<table class="popupally-setting-configure-table">
						<tbody>
							<tr>
								<td style="width:40%;">
									<select popupally-change-source="plsbvs-location-selection-{{id}}" name="[{{id}}][plsbvs-popup-location]">
									{{plsbvs-location-selection}}
									</select>
								</td>
			...
			<div class="popupally-setting-configure-block" hide-toggle="plsbvs-popup-location" data-dependency="plsbvs-location-selection-{{id}}" data-dependency-value="other">
				<div class="popupally-setting-section-sub-header">Vertical Position</div>
				<div>
					<div>
						Define vertical position by distance to the
						<select popupally-change-source="plsbvs-location-vertical-selection-{{id}}" name="[{{id}}][plsbvs-popup-vertical-selection]">
							{{plsbvs-location-vertical-selection}}
						</select>
						of the page.
					</div>
					<table class="popupally-setting-configure-table">
						<tbody>
							<tr hide-toggle="plsbvs-popup-vertical-selection" data-dependency="plsbvs-location-vertical-selection-{{id}}" data-dependency-value="top">
								<td style="width:20%;">
									Distance to the top of the page
								</td>
								<td style="width:30%;">
									<input style="margin-left:10px;" size="8" name="[{{id}}][plsbvs-popup-top]" type="text" value="{{plsbvs-popup-top}}">
								</td>
								<td><div class="popupally-inline-help-text">Please specify either &quot;%&quot; or &quot;px&quot;.</div></td>
							</tr>
							<tr hide-toggle="plsbvs-popup-vertical-selection" data-dependency="plsbvs-location-vertical-selection-{{id}}" data-dependency-value="bottom">
								<td style="width:20%;">
									Distance to the bottom of the page
								</td>
								<td style="width:30%;">
									<input style="margin-left:10px;" size="8" name="[{{id}}][plsbvs-popup-bottom]" type="text" value="{{plsbvs-popup-bottom}}">
								</td>
								<td><div class="popupally-inline-help-text">Please specify either &quot;%&quot; or &quot;px&quot;.</div></td>
							</tr>
						</tbody>
			...
			<div class="popupally-setting-configure-block" hide-toggle="plsbvs-popup-location" data-dependency="plsbvs-location-selection-{{id}}" data-dependency-value="other">
				...
				<div>
					<div>
						...
						<select popupally-change-source="plsbvs-location-horizontal-selection-{{id}}" name="[{{id}}][plsbvs-popup-horizontal-selection]">
							{{plsbvs-location-horizontal-selection}}
						</select>
						of the page.
					</div>
					<table class="popupally-setting-configure-table">
						<tbody>
							<tr hide-toggle="plsbvs-popup-horizontal-selection" data-dependency="plsbvs-location-horizontal-selection-{{id}}" data-dependency-value="left">
								<td style="width:20%;">
									Distance to the left of the page
								</td>
								<td style="width:30%;">
									<input style="margin-left:10px;" size="8" name="[{{id}}][plsbvs-popup-left]" type="text" value="{{plsbvs-popup-left}}">
								</td>
								<td><div class="popupally-inline-help-text">Please specify either &quot;%&quot; or &quot;px&quot;.</div></td>
							</tr>
							<tr hide-toggle="plsbvs-popup-horizontal-selection" data-dependency="plsbvs-location-horizontal-selection-{{id}}" data-dependency-value="right">
								<td style="width:20%;">
									Distance to the right of the page
								</td>
								<td style="width:30%;">
									<input style="margin-left:10px;" size="8" name="[{{id}}][plsbvs-popup-right]" type="text" value="{{plsbvs-popup-right}}">
								</td>
								<td><div class="popupally-inline-help-text">Please specify either &quot;%&quot; or &quot;px&quot;.</div></td>
							</tr>
						</tbody>
				...
				<div>
					<table class="popupally-setting-configure-table">
						<tbody>
							<tr>
								<td style="width:40%;">
									<div><input size="8" class="nqpc-picker-input-iyxm" name="[{{id}}][plsbvs-background-color]" type="text" value="{{plsbvs-background-color}}" preview-update-target-css=".popupally-pro-outer-preview-background-plsbvs-{{id}}" preview-update-target-css-property="background-color" data-default-color="#d3d3d3"></div>
								</td>
		...
		<div class="popupally-configure-element" id="plsbvs-config-name-input-{{id}}">
			<div class="popupally-setting-configure-block">
				...
				<div>
					<input popupally-change-source="plsbvs-hide-name-field-{{id}}" id="plsbvs-hide-name-field-{{id}}" name="[{{id}}][plsbvs-hide-name-field]" {{plsbvs-hide-name-field}} signup-form-hide="name" popup-id="{{id}}" template-id="plsbvs" type="checkbox" value="true" preview-update-target-hide-checked=".plsbvs-preview-name-{{id}}">
					<label for="plsbvs-hide-name-field-{{id}}">Yes</label>
				</div>
			</div>

			<div class="popupally-setting-configure-block" hide-toggle="plsbvs-hide-name-field" data-dependency="plsbvs-hide-name-field-{{id}}" data-dependency-value="false">
		...
		<div class="popupally-configure-element">
					...
					<table class="popupally-setting-configure-table">
						<tbody>
							<tr>
								<td style="width:40%;">
									<div>
										<input popupally-change-source="plsbvs-hide-overlay-{{id}}" id="plsbvs-hide-overlay-{{id}}" name="[{{id}}][plsbvs-hide-overlay]" {{plsbvs-hide-overlay}} type="checkbox" value="true">
										<label for="plsbvs-hide-overlay-{{id}}">Yes</label>
									</div>
								</td>
			...
			<div hide-toggle="plsbvs-hide-overlay" data-dependency="plsbvs-hide-overlay-{{id}}" data-dependency-value="false">
				<div class="popupally-setting-configure-block">
							...
							<tbody>
								<tr>
									<td style="width:60%;">
										<div>
											Color
											<input size="8" class="nqpc-picker-input-iyxm" name="[{{id}}][plsbvs-overlay-color]" type="text" value="{{plsbvs-overlay-color}}" data-default-color="#505050">
											Opacity
											<input size="4" name="[{{id}}][plsbvs-overlay-opacity]" type="text" value="{{plsbvs-overlay-opacity}}">
										</div>
									</td>
						...
						<table class="popupally-setting-configure-table">
							<tbody>
								<tr>
									<td style="width:40%;">
										<div>
											<input id="plsbvs-disable-overlay-close-{{id}}" name="[{{id}}][plsbvs-disable-overlay-close]" {{plsbvs-disable-overlay-close}} type="checkbox" value="true">
											<label for="plsbvs-disable-overlay-close-{{id}}">Yes</label>
										</div>
									</td>
					...
					<table class="popupally-setting-configure-table">
						<tbody>
							<tr>
								<td style="width:40%;">
									<div>
										<input id="plsbvs-show-embedded-border-{{id}}" name="[{{id}}][plsbvs-show-embedded-border]" {{plsbvs-show-embedded-border}} type="checkbox" value="true">
										<label for="plsbvs-show-embedded-border-{{id}}">Yes</label>
									</div>
								</td>
...
<div style="display:none;" class="popupally-sub-setting-content-container" popupally-responsive-tab-group-{{id}}-plsbvs="1">
	...
	<div class="popupally-setting-section" id="plsbvs-customization-960-section-{{id}}">
		...
		<div class="popupally-configure-element" hide-toggle="plsbvs-popup-location" data-dependency="plsbvs-location-selection-{{id}}" data-dependency-value="other">
			<div class="popupally-setting-configure-block">
				<div class="popupally-setting-section-sub-header">Popup Location</div>
				<div class="popupally-setting-section-sub-header">Vertical Position</div>
				<div>
					<table class="popupally-setting-configure-table">
						<tbody>
							<tr hide-toggle="plsbvs-popup-vertical-selection" data-dependency="plsbvs-location-vertical-selection-{{id}}" data-dependency-value="top">
								...
								<td style="width:30%;">
									<input style="margin-left:10px;" size="8" name="[{{id}}][plsbvs-popup-960-top]" type="text" value="{{plsbvs-popup-960-top}}">
								</td>
								<td><div class="popupally-inline-help-text">Please specify either &quot;%&quot; or &quot;px&quot;.</div></td>
							</tr>
							<tr hide-toggle="plsbvs-popup-vertical-selection" data-dependency="plsbvs-location-vertical-selection-{{id}}" data-dependency-value="bottom">
								...
								<td style="width:30%;">
									<input style="margin-left:10px;" size="8" name="[{{id}}][plsbvs-popup-960-bottom]" type="text" value="{{plsbvs-popup-960-bottom}}">
								</td>
								<td><div class="popupally-inline-help-text">Please specify either &quot;%&quot; or &quot;px&quot;.</div></td>
							</tr>
						</tbody>
					...
					<table class="popupally-setting-configure-table">
						<tbody>
							<tr hide-toggle="plsbvs-popup-horizontal-selection" data-dependency="plsbvs-location-horizontal-selection-{{id}}" data-dependency-value="left">
								...
								<td style="width:30%;">
									<input style="margin-left:10px;" size="8" name="[{{id}}][plsbvs-popup-960-left]" type="text" value="{{plsbvs-popup-960-left}}">
								</td>
								<td><div class="popupally-inline-help-text">Please specify either &quot;%&quot; or &quot;px&quot;.</div></td>
							</tr>
							<tr hide-toggle="plsbvs-popup-horizontal-selection" data-dependency="plsbvs-location-horizontal-selection-{{id}}" data-dependency-value="right">
								...
								<td style="width:30%;">
									<input style="margin-left:10px;" size="8" name="[{{id}}][plsbvs-popup-960-right]" type="text" value="{{plsbvs-popup-960-right}}">
								</td>
								<td><div class="popupally-inline-help-text">Please specify either &quot;%&quot; or &quot;px&quot;.</div></td>
							</tr>
						</tbody>
		...
		<div class="popupally-configure-element" id="plsbvs-config-name-input-960-{{id}}" hide-toggle="plsbvs-hide-name-field" data-dependency="plsbvs-hide-name-field-{{id}}" data-dependency-value="false">
			<div class="popupally-setting-configure-block">
...
<div style="display:none;" class="popupally-sub-setting-content-container" popupally-responsive-tab-group-{{id}}-plsbvs="2">
	...
	<div class="popupally-setting-section" id="plsbvs-customization-640-section-{{id}}">
					...
					<table class="popupally-setting-configure-table">
						<tbody>
							<tr hide-toggle="plsbvs-popup-vertical-selection" data-dependency="plsbvs-location-vertical-selection-{{id}}" data-dependency-value="top">
								...
								<td style="width:30%;">
									<input style="margin-left:10px;" size="8" name="[{{id}}][plsbvs-popup-640-top]" type="text" value="{{plsbvs-popup-640-top}}">
								</td>
								<td><div class="popupally-inline-help-text">Please specify either &quot;%&quot; or &quot;px&quot;.</div></td>
							</tr>
							<tr hide-toggle="plsbvs-popup-vertical-selection" data-dependency="plsbvs-location-vertical-selection-{{id}}" data-dependency-value="bottom">
								...
								<td style="width:30%;">
									<input style="margin-left:10px;" size="8" name="[{{id}}][plsbvs-popup-640-bottom]" type="text" value="{{plsbvs-popup-640-bottom}}">
								</td>
								<td><div class="popupally-inline-help-text">Please specify either &quot;%&quot; or &quot;px&quot;.</div></td>
							</tr>
						</tbody>
					...
					<table class="popupally-setting-configure-table">
						<tbody>
							<tr hide-toggle="plsbvs-popup-horizontal-selection" data-dependency="plsbvs-location-horizontal-selection-{{id}}" data-dependency-value="left">
								...
								<td style="width:30%;">
									<input style="margin-left:10px;" size="8" name="[{{id}}][plsbvs-popup-640-left]" type="text" value="{{plsbvs-popup-640-left}}">
								</td>
								<td><div class="popupally-inline-help-text">Please specify either &quot;%&quot; or &quot;px&quot;.</div></td>
							</tr>
							<tr hide-toggle="plsbvs-popup-horizontal-selection" data-dependency="plsbvs-location-horizontal-selection-{{id}}" data-dependency-value="right">
								...
								<td style="width:30%;">
									<input style="margin-left:10px;" size="8" name="[{{id}}][plsbvs-popup-640-right]" type="text" value="{{plsbvs-popup-640-right}}">
								</td>
								<td><div class="popupally-inline-help-text">Please specify either &quot;%&quot; or &quot;px&quot;.</div></td>
							</tr>
						</tbody>
		...
		<div class="popupally-configure-element" id="plsbvs-config-name-input-640-{{id}}" hide-toggle="plsbvs-hide-name-field" data-dependency="plsbvs-hide-name-field-{{id}}" data-dependency-value="false">
			<div class="popupally-setting-configure-block">
				<div class="popupally-setting-section-sub-header">Name Input Position</div>
				<div>
					<div class="popupally-style-same-line-block">
