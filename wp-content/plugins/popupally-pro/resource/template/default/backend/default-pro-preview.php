...
<div class="popupally-sub-setting-content-container" popupally-responsive-tab-group-{{id}}-bxsjbi="0">
	...
	<input style="display:none;" type="checkbox" popup-id="{{id}}" template-id="bxsjbi" signup-form-hide="form" value="true"/>
	<input style="display:none;" type="checkbox" checked popup-id="{{id}}" template-id="bxsjbi" signup-form-hide="lname" value="true"/>
	<input style="display:none;" type="checkbox" popup-id="{{id}}" template-id="bxsjbi" signup-form-hide="email" value="true"/>
	<div class="popupally-setting-section" id="customization-section-{{id}}">
		...
		<div class="popupally-configure-element">
				...
				<div>
					<table class="popupally-setting-configure-table">
						<tbody>
							<tr>
								<td style="width:40%;">
									<select popupally-change-source="bxsjbi-location-selection-{{id}}" name="[{{id}}][bxsjbi-popup-location]">
									{{bxsjbi-location-selection}}
									</select>
								</td>
			...
			<div class="popupally-setting-configure-block" hide-toggle="bxsjbi-popup-location" data-dependency="bxsjbi-location-selection-{{id}}" data-dependency-value="other">
				<div class="popupally-setting-section-sub-header">Vertical Position</div>
				<div>
					<div>
						Define vertical position by distance to the
						<select popupally-change-source="bxsjbi-location-vertical-selection-{{id}}" name="[{{id}}][bxsjbi-popup-vertical-selection]">
							{{bxsjbi-location-vertical-selection}}
						</select>
						of the page.
					</div>
					<table class="popupally-setting-configure-table">
						<tbody>
							<tr hide-toggle="bxsjbi-popup-vertical-selection" data-dependency="bxsjbi-location-vertical-selection-{{id}}" data-dependency-value="top">
								<td style="width:20%;">
									Distance to the top of the page
								</td>
								<td style="width:30%;">
									<input style="margin-left:10px;" size="8" name="[{{id}}][bxsjbi-popup-top]" type="text" value="{{bxsjbi-popup-top}}">
								</td>
								<td><div class="popupally-inline-help-text">Please specify either &quot;%&quot; or &quot;px&quot;.</div></td>
							</tr>
							<tr hide-toggle="bxsjbi-popup-vertical-selection" data-dependency="bxsjbi-location-vertical-selection-{{id}}" data-dependency-value="bottom">
								<td style="width:20%;">
									Distance to the bottom of the page
								</td>
								<td style="width:30%;">
									<input style="margin-left:10px;" size="8" name="[{{id}}][bxsjbi-popup-bottom]" type="text" value="{{bxsjbi-popup-bottom}}">
								</td>
								<td><div class="popupally-inline-help-text">Please specify either &quot;%&quot; or &quot;px&quot;.</div></td>
							</tr>
						</tbody>
			...
			<div class="popupally-setting-configure-block" hide-toggle="bxsjbi-popup-location" data-dependency="bxsjbi-location-selection-{{id}}" data-dependency-value="other">
				...
				<div>
					<div>
						...
						<select popupally-change-source="bxsjbi-location-horizontal-selection-{{id}}" name="[{{id}}][bxsjbi-popup-horizontal-selection]">
							{{bxsjbi-location-horizontal-selection}}
						</select>
						of the page.
					</div>
					<table class="popupally-setting-configure-table">
						<tbody>
							<tr hide-toggle="bxsjbi-popup-horizontal-selection" data-dependency="bxsjbi-location-horizontal-selection-{{id}}" data-dependency-value="left">
								<td style="width:20%;">
									Distance to the left of the page
								</td>
								<td style="width:30%;">
									<input style="margin-left:10px;" size="8" name="[{{id}}][bxsjbi-popup-left]" type="text" value="{{bxsjbi-popup-left}}">
								</td>
								<td><div class="popupally-inline-help-text">Please specify either &quot;%&quot; or &quot;px&quot;.</div></td>
							</tr>
							<tr hide-toggle="bxsjbi-popup-horizontal-selection" data-dependency="bxsjbi-location-horizontal-selection-{{id}}" data-dependency-value="right">
								<td style="width:20%;">
									Distance to the right of the page
								</td>
								<td style="width:30%;">
									<input style="margin-left:10px;" size="8" name="[{{id}}][bxsjbi-popup-right]" type="text" value="{{bxsjbi-popup-right}}">
								</td>
								<td><div class="popupally-inline-help-text">Please specify either &quot;%&quot; or &quot;px&quot;.</div></td>
							</tr>
						</tbody>
				...
				<div>
					<table class="popupally-setting-configure-table">
						<tbody>
							<tr>
								<td style="width:40%;">
									<div><input size="8" class="nqpc-picker-input-iyxm" name="[{{id}}][background-color]" type="text" value="{{background-color}}" preview-update-target-css=".popupally-pro-outer-preview-background-bxsjbi-{{id}}" preview-update-target-css-property="background-color" data-default-color="#FFFFFF"></div>
								</td>
		...
		<div class="popupally-configure-element" id="bxsjbi-sales-text-{{id}}" hide-toggle="bxsjbi-logo-row-hide-toggle" data-dependency="bxsjbi-logo-row-hide-toggle-{{id}}" data-dependency-value="false">
			...
			<div class="popupally-setting-configure-block">
				<div class="popupally-setting-section-sub-header">Introduction Row Margin<div class="popupally-info-icon popupally-info-bubble"><div info="Controls the spacing above and below the introduction row"></div></div></div>
				<div>
					<span class="two-by-two-input">
						<label>Top</label>
						<input size="6" name="[{{id}}][logo-row-margin-top]" type="text" value="{{logo-row-margin-top}}" preview-update-target-css=".logo-row-{{id}}" preview-update-target-css-property-px="margin-top">px
					</span>
					<span class="two-by-two-input">
						<label>Bottom</label>
						<input size="6" name="[{{id}}][logo-row-margin-bottom]" type="text" value="{{logo-row-margin-bottom}}" preview-update-target-css=".logo-row-{{id}}" preview-update-target-css-property-px="margin-bottom">px
					</span>
				</div>
			</div>
		</div>
		...
		<div class="popupally-configure-element" id="bxsjbi-name-input-{{id}}">
			...
			<div class="popupally-setting-configure-block">
				...
				<div>
					<input id="hide-name-field-{{id}}" name="[{{id}}][hide-name-field]" {{hide-name-field}} signup-form-hide="name" popup-id="{{id}}" template-id="bxsjbi" type="checkbox" value="true" preview-update-target-hide-checked=".preview-name-{{id}}">
					<label for="hide-name-field-{{id}}">Yes</label>
				</div>
			</div>
		</div>
		...
		<div class="popupally-configure-element" id="bxsjbi-subscribe-button-{{id}}">
			...
			<div class="popupally-setting-configure-block">
				<div class="popupally-setting-section-sub-header">Subscribe Button Margin<div class="popupally-info-icon popupally-info-bubble"><div info="Controls the spacing above and below the subscrube button"></div></div></div>
				<div>
					<span class="two-by-two-input">
						<label>Top</label>
						<input size="6" name="[{{id}}][subscribe-button-margin-top]" type="text" value="{{subscribe-button-margin-top}}" preview-update-target-css=".subscribe-button-{{id}}" preview-update-target-css-property-px="margin-top">px
					</span>
					<span class="two-by-two-input">
						<label>Bottom</label>
						<input size="6" name="[{{id}}][subscribe-button-margin-bottom]" type="text" value="{{subscribe-button-margin-bottom}}" preview-update-target-css=".subscribe-button-{{id}}" preview-update-target-css-property-px="margin-bottom">px
					</span>
				</div>
			</div>
		</div>
			...
			<div hide-toggle="bxsjbi-privacy-hide-toggle" data-dependency="bxsjbi-privacy-hide-toggle-{{id}}" data-dependency-value="false">
				...
				<div class="popupally-setting-configure-block">
					...
					<div>
						<span class="two-by-two-input">
							<label>Top</label>
							<input size="6" name="[{{id}}][privacy-text-margin-top]" type="text" value="{{privacy-text-margin-top}}" preview-update-target-css=".privacy-text-{{id}}" preview-update-target-css-property-px="margin-top">px
						</span>
						<span class="two-by-two-input">
							<label>Bottom</label>
							<input size="6" name="[{{id}}][privacy-text-margin-bottom]" type="text" value="{{privacy-text-margin-bottom}}" preview-update-target-css=".privacy-text-{{id}}" preview-update-target-css-property-px="margin-bottom">px
						</span>
					</div>
				</div>
			</div>
		...
		<div class="popupally-configure-element">
					...
					<table class="popupally-setting-configure-table">
						<tbody>
							<tr>
								<td style="width:40%;">
									<div>
										<input popupally-change-source="bxsjbi-hide-overlay-{{id}}" id="bxsjbi-hide-overlay-{{id}}" name="[{{id}}][bxsjbi-hide-overlay]" {{bxsjbi-hide-overlay}} type="checkbox" value="true">
										<label for="bxsjbi-hide-overlay-{{id}}">Yes</label>
									</div>
								</td>
			...
			<div hide-toggle="bxsjbi-hide-overlay" data-dependency="bxsjbi-hide-overlay-{{id}}" data-dependency-value="false">
				<div class="popupally-setting-configure-block">
						...
						<table class="popupally-setting-configure-table">
							<tbody>
								<tr>
									<td style="width:40%;">
										<div>
											<input id="disable-overlay-close-{{id}}" name="[{{id}}][disable-overlay-close]" {{disable-overlay-close}} type="checkbox" value="true">
											<label for="disable-overlay-close-{{id}}">Yes</label>
										</div>
									</td>
							...
							<tbody>
								<tr>
									<td style="width:60%;">
										<div>
											Color
											<input size="8" class="nqpc-picker-input-iyxm" name="[{{id}}][overlay-color]" type="text" value="{{overlay-color}}" data-default-color="#505050">
											Opacity
											<input size="4" name="[{{id}}][overlay-opacity]" type="text" value="{{overlay-opacity}}">
										</div>
									</td>
					...
					<table class="popupally-setting-configure-table">
						<tbody>
							<tr>
								<td style="width:40%;">
									<div>
										<input id="bxsjbi-show-embedded-border-{{id}}" name="[{{id}}][bxsjbi-show-embedded-border]" {{bxsjbi-show-embedded-border}} type="checkbox" value="true">
										<label for="bxsjbi-show-embedded-border-{{id}}">Yes</label>
									</div>
								</td>
...
<div style="display:none;" class="popupally-sub-setting-content-container" popupally-responsive-tab-group-{{id}}-bxsjbi="1">
	...
	<div class="popupally-setting-section" id="bxsjbi-customization-960-section-{{id}}">
		...
		<div class="popupally-configure-element" hide-toggle="bxsjbi-popup-location" data-dependency="bxsjbi-location-selection-{{id}}" data-dependency-value="other">
			<div class="popupally-setting-configure-block">
				<div class="popupally-setting-section-sub-header">Popup Location</div>
				<div class="popupally-setting-section-sub-header">Vertical Position</div>
				<div>
					<table class="popupally-setting-configure-table">
						<tbody>
							<tr hide-toggle="bxsjbi-popup-vertical-selection" data-dependency="bxsjbi-location-vertical-selection-{{id}}" data-dependency-value="top">
								...
								<td style="width:30%;">
									<input style="margin-left:10px;" size="8" name="[{{id}}][bxsjbi-popup-960-top]" type="text" value="{{bxsjbi-popup-960-top}}">
								</td>
								<td><div class="popupally-inline-help-text">Please specify either &quot;%&quot; or &quot;px&quot;.</div></td>
							</tr>
							<tr hide-toggle="bxsjbi-popup-vertical-selection" data-dependency="bxsjbi-location-vertical-selection-{{id}}" data-dependency-value="bottom">
								...
								<td style="width:30%;">
									<input style="margin-left:10px;" size="8" name="[{{id}}][bxsjbi-popup-960-bottom]" type="text" value="{{bxsjbi-popup-960-bottom}}">
								</td>
								<td><div class="popupally-inline-help-text">Please specify either &quot;%&quot; or &quot;px&quot;.</div></td>
							</tr>
						</tbody>
					...
					<table class="popupally-setting-configure-table">
						<tbody>
							<tr hide-toggle="bxsjbi-popup-horizontal-selection" data-dependency="bxsjbi-location-horizontal-selection-{{id}}" data-dependency-value="left">
								...
								<td style="width:30%;">
									<input style="margin-left:10px;" size="8" name="[{{id}}][bxsjbi-popup-960-left]" type="text" value="{{bxsjbi-popup-960-left}}">
								</td>
								<td><div class="popupally-inline-help-text">Please specify either &quot;%&quot; or &quot;px&quot;.</div></td>
							</tr>
							<tr hide-toggle="bxsjbi-popup-horizontal-selection" data-dependency="bxsjbi-location-horizontal-selection-{{id}}" data-dependency-value="right">
								...
								<td style="width:30%;">
									<input style="margin-left:10px;" size="8" name="[{{id}}][bxsjbi-popup-960-right]" type="text" value="{{bxsjbi-popup-960-right}}">
								</td>
								<td><div class="popupally-inline-help-text">Please specify either &quot;%&quot; or &quot;px&quot;.</div></td>
							</tr>
						</tbody>
					...
					<table class="popupally-setting-configure-table">
						<tbody>
							<tr hide-toggle="bxsjbi-popup-vertical-selection" data-dependency="bxsjbi-location-vertical-selection-{{id}}" data-dependency-value="top">
								...
								<td style="width:30%;">
									<input style="margin-left:10px;" size="8" name="[{{id}}][bxsjbi-popup-640-top]" type="text" value="{{bxsjbi-popup-640-top}}">
								</td>
								<td><div class="popupally-inline-help-text">Please specify either &quot;%&quot; or &quot;px&quot;.</div></td>
							</tr>
							<tr hide-toggle="bxsjbi-popup-vertical-selection" data-dependency="bxsjbi-location-vertical-selection-{{id}}" data-dependency-value="bottom">
								...
								<td style="width:30%;">
									<input style="margin-left:10px;" size="8" name="[{{id}}][bxsjbi-popup-640-bottom]" type="text" value="{{bxsjbi-popup-640-bottom}}">
								</td>
								<td><div class="popupally-inline-help-text">Please specify either &quot;%&quot; or &quot;px&quot;.</div></td>
							</tr>
						</tbody>
					...
					<table class="popupally-setting-configure-table">
						<tbody>
							<tr hide-toggle="bxsjbi-popup-horizontal-selection" data-dependency="bxsjbi-location-horizontal-selection-{{id}}" data-dependency-value="left">
								...
								<td style="width:30%;">
									<input style="margin-left:10px;" size="8" name="[{{id}}][bxsjbi-popup-640-left]" type="text" value="{{bxsjbi-popup-640-left}}">
								</td>
								<td><div class="popupally-inline-help-text">Please specify either &quot;%&quot; or &quot;px&quot;.</div></td>
							</tr>
							<tr hide-toggle="bxsjbi-popup-horizontal-selection" data-dependency="bxsjbi-location-horizontal-selection-{{id}}" data-dependency-value="right">
								...
								<td style="width:30%;">
									<input style="margin-left:10px;" size="8" name="[{{id}}][bxsjbi-popup-640-right]" type="text" value="{{bxsjbi-popup-640-right}}">
								</td>
								<td><div class="popupally-inline-help-text">Please specify either &quot;%&quot; or &quot;px&quot;.</div></td>
							</tr>
						</tbody>
