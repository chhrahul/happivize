...
function wppb_create_recover_password_form( $user, $post_data ){
	...
	<form enctype="multipart/form-data" method="post" id="wppb-recover-password" class="wppb-user-forms" action="<?php echo esc_url( add_query_arg( 'finalAction', 'yes', wppb_curpageurl() ) ); ?>">
		...
		<ul style="width: 35%;margin: 0 auto;">
		<style type="text/css">
			...
			#wppb-recover-password .form-submit input#wppb-recover-password-button {
			    padding: 9px 24px !important;
			    border-radius: 24px !important;
			}
			.wppb-form-field input::-webkit-input-placeholder {
			    font-size: 16px;
			    line-height: 3;
			}
		</style>
	<?php
		...
		$password_label = __( 'New Password', 'profile-builder' );
 ...
 */
 ...
 function wppb_create_generate_password_form( $post_data ){
	...
	<p class="form-submit">
		...
		<input name="recover_password" style="padding: 1.4% 8.5% !important;" type="submit" id="wppb-recover-password-button" class="submit button" value="<?php echo apply_filters('wppb_recover_password_button_name3', $button_name); ?>" />
	...
	if ( 'POST' == $_SERVER['REQUEST_METHOD'] && !empty( $_POST['action'] ) && $_POST['action'] == 'recover_password' && wp_verify_nonce($_POST['password_recovery_nonce_field'],'verify_true_password_recovery') ) {
        ...
        if( $messageNo == '1' ) {
            ...
            if( !empty( $query[0] ) ){
                ...
                $recoveruserMailMessage1 = '<div id="m_-5662514661390073732wrapper" dir="ltr" style="background-color:#ffffff;margin:0;padding:70px 0 70px 0;width:100%"><table border="0" cellpadding="0" cellspacing="0" height="100%" width="100%"><tbody><tr><td align="center" valign="top"><div id="m_-5662514661390073732template_header_image"><p style="margin-top:0;margin-bottom:0;height:107px"><img src="https://happivize.com/wp-content/uploads/2017/03/happivize-logo-e1488924082347.png" alt="Happivize" style="border:none;display:inline;font-size:14px;font-weight:bold;height:auto;line-height:100%;outline:none;text-decoration:none;text-transform:capitalize" class="CToWUd"></p></div><table border="0" cellpadding="0" cellspacing="0" style="border:0px!important;background-color:#ffffff;border-radius:3px!important" width="600" id="m_-5662514661390073732template_container"><tbody><tr><td align="center" valign="top"><table border="0" cellpadding="0" cellspacing="0" width="600" style="background:none!important;background-color:#505050;border-radius:3px 3px 0 0!important;color:#ffffff;border-bottom:0;font-weight:bold;line-height:100%;vertical-align:middle;font-family:&quot;Helvetica Neue&quot;,Helvetica,Roboto,Arial,sans-serif" id="m_-5662514661390073732template_header"><tbody><tr><td id="m_-5662514661390073732header_wrapper" style="padding:36px 48px;display:block"><h1 style="text-align:center!important;color:#000!important;font-family:&quot;Helvetica Neue&quot;,Helvetica,Roboto,Arial,sans-serif;font-size:30px;font-weight:300;line-height:150%;margin:0">Password Reset Instructions </h1></td></tr></tbody></table></td></tr><tr><td align="center" valign="top"><table border="0" cellpadding="0" cellspacing="0" width="600" id="m_-5662514661390073732template_body"><tbody><tr><td valign="top" id="m_-5662514661390073732body_content" style="background-color:#ffffff"><table border="0" cellpadding="20" cellspacing="0" width="100%"><tbody><tr><td valign="top" style="padding:48px"><div id="m_-5662514661390073732body_content_inner" style="color:#737373;font-family:&quot;Helvetica Neue&quot;,Helvetica,Roboto,Arial,sans-serif;font-size:14px;line-height:150%;text-align:left"><p style="margin:0 0 16px">Someone requested that the password be reset for the following account:</p><p style="margin:0 0 16px">Username: '.$display_username_email.'</p><p style="margin:0 0 16px">If this was a mistake, just ignore this email and nothing will happen.</p><p style="margin:0 0 16px">To reset your password, visit the following address:</p><p style="margin:0 0 16px"><a href="'.esc_url( add_query_arg( array( 'loginName' => $requestedUserNicename, 'key' => $key ), wppb_curpageurl() ) ).'">'.esc_url( add_query_arg( array( 'loginName' => $requestedUserNicename, 'key' => $key ), wppb_curpageurl() ) ).'</a></p><p style="margin:0 0 16px"></p></div></td></tr></tbody></table></td></tr></tbody></table></td></tr></tbody></table></td></tr></tbody></table><div class="yj6qo"></div><div class="adL"></div></div>';
