...
function column_wrapper ($data) {
	...
	<div class="sub_testimoial">
		<div class="testimonial_img">
			<img src="<?php echo get_home_url(); ?>/wp-content/uploads/2017/04/avatar.jpg">
		</div>
	...
	<div class="title_h3"><h3 class="rr_title" itemprop="name"><?php echo $data['rTitle']; ?></h3> </div>
	<div>
