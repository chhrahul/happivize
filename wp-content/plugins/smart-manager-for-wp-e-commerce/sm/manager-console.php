...
$products_cols['sku']['name']=__( 'Speakers Name', $sm_text_domain );
...
$products_cols['group']['name']=__( 'Last Updated', $sm_text_domain );
...
function sm_product_columns_filter($attr) {
	...
	$meta_key_ignored = array( '_visibility','_regular_price','_sale_price', '_stock',
