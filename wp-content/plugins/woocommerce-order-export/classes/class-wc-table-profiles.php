	...
	function column_default( $item, $column_name ) {
		switch ( $column_name ) {
			...
			case 'actions':
				...
				'<div class="btn-to-actions button-secondary" data-id="' . $item['id'] . '" title="' . __( 'Copy to Actions', 'woocommerce-order-export' ) . '"><span class="dashicons dashicons-migrate"></span></div>&nbsp;'.
				'<div class="btn-to-scheduled button-secondary" data-id="' . $item['id'] . '" title="' . __( 'Copy to Scheduled', 'woocommerce-order-export' ) . '"><span class="dashicons dashicons-clock"></span></div>&nbsp;'.
