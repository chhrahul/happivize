	...
	switch ($woof_settings['tax_type'][$tax_slug]) {
		...
		function woof_print_item_by_key($key, $woof_settings, $additional_taxes) {
		    ...
		    <?php if (isset($WOOF->settings['by_price']['title_text']) AND ! empty($WOOF->settings['by_price']['title_text'])): ?>
				    <<?php echo apply_filters('woof_title_tag', 'h4'); ?>><?php echo WOOF_HELPER::wpml_translate(null, $WOOF->settings['by_price']['title_text']); ?>

				 <a href="javascript: void(0);" title="toggle" class="woof_front_toggle woof_front_toggle_opened" data-condition="opened">
                    <img src="https://happivize.com/wp-content/uploads/2017/05/Screenshot_1.png" alt="toggle">
                </a>
