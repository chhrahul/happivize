...
class WCS_Email_Customer_Payment_Retry extends WCS_Email_Customer_Renewal_Invoice {
	...
	function trigger( $order_id, $order = null ) {
		...
		$this->subject  =  "Action Required: Payment not going through for ".$subjectt_pro."";
	...
	function get_subject() {
		return apply_filters( 'woocommerce_subscriptions_email_subject_customer_retry', $this->format_string( $this->subject ) , $this->object );
	}
