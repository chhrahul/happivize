	...
	<div id="woocommerce_product_tabs" class="panel wc-metaboxes-wrapper">
		<p class="toolbar">
			<?php if ( 'product' === $typenow ) :
				...
				?>
				<label for="_override_tab_layout"><?php esc_html_e( 'Override default tab layout:', 'woocommerce-tab-manager' ); ?></label> <input type="checkbox" name="_override_tab_layout" id="_override_tab_layout" checked <?php // checked( $override_tab_layout, "yes" ); ?> />
			<?php endif; ?>
