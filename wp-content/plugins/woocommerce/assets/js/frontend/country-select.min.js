    ...
    a('#billing_state_field').css('visibility','visible');
        ...
        var b = a(this).val(),
          ...
          // alert(b);
           ...
           {
              j = 'County *';
              a("#select2-chosen-2").html('County *');
           }  */
          // alert(j)    
        if (e[b])
