...
class WC_Checkout {
	...
	public function __construct () {
      ...
      /*  echo "<pre>";
		print_r($this->checkout_fields['billing']);*/
								...
								switch ( $rule ) {
									case 'postcode' :
										...
										if ( ! WC_Validation::is_postcode( $this->posted[ $key ], $_POST[ $fieldset_key . '_country' ] ) ) :
											wc_add_notice( __( 'Your zip/postal code doesn\'t seem to be working. <a href=# id=pin>Click here</a> to update.', 'woocommerce' ), 'error' );
										else :
