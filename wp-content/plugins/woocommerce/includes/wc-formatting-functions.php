...
function wc_price( $price, $args = array() ) {
	...
	$price           = apply_filters( 'formatted_woocommerce_price', number_format( $price, 0 , $decimal_separator, $thousand_separator ), $price, $decimals, $decimal_separator, $thousand_separator );
