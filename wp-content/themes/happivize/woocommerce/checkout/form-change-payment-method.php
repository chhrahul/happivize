...
?>
<form id="order_review" method="post" class="change_pymnt_this">
		<h1 style="color:#ff9933" class="entry-title">Change Payment Method</h1>	
...
<style type="text/css">
	 .woocommerce-order-pay .woocommerce form#order_review.change_pymnt_this{display: block;}
	 .change_pymnt_this div#payment {
	    width: 85%;
	}
</style>